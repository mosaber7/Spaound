...
class OnBoardingViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        skipButton.addTarget(self, action: #selector(getStarted(_:)), for: .touchUpInside)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row == 0 {
            ...
            cell.actionButton.addTarget(self, action: #selector(getStarted(_:)), for: .touchUpInside)
